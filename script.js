...
function passwordOptions() {
  ...
  if (addSpecialCharacters === false && addNumericCharacters === false &&
    addUpperCase === false && addLowerCase === false) {
...
// for loop to add available characters to the random character array
  for (let i = 0; i < passwordLength; i++) {
    var randomCharacter = allAvailableCharacters[Math.floor(Math.random() * allAvailableCharacters.length)];
